...
(() => {
  ...
  let notificacoes = [
    { id:'n1', titulo:'Nova atualização disponível', texto:'Uma nova versão do sistema está disponível para instalação.', conteudo:'Versão 2.8.1 disponível.\n\nNovidades:\n• Melhorias de desempenho\n• Correções de segurança\n\nClique em "Ir para" para abrir a página de atualização.', quando:'Há 5 minutos', href:'#atualizacao', unread:true },
    { id:'n2', titulo:'Backup concluído', texto:'O backup automático dos seus dados foi concluído com sucesso.', conteudo:'Backup finalizado às 13:02.\nTotal de arquivos: 1.245\nTamanho: 2,4 GB\n\nVocê pode restaurar itens a partir do painel de Backups.', quando:'Há 1 hora', href:'#backup', unread:true },
    { id:'n3', titulo:'Manutenção programada', texto:'O sistema entrará em manutenção amanhã às 02:00.', conteudo:'Janela de manutenção: 02:00–03:30 (BRT).\nServiços afetados: autenticação e relatórios.\n\nDurante o período, o login pode ficar indisponível.', quando:'Há 3 horas', href:'#manutencao', unread:false },
    { id:'n4', titulo:'Novo comentário', texto:'Você recebeu um novo comentário no seu relatório.', conteudo:'"Conferi os números da seção 3 e acrescentei observações."\n\nAbra o relatório para responder.', quando:'Ontem', href:'#comentario', unread:false },
  ];
  ...
  /* ===== Helpers ===== */
  function unreadCount(){ return notificacoes.filter(n => n.unread).length; }
  ...
  function onEscPopover(e){ if (e.key === 'Escape') closePopover(); }
